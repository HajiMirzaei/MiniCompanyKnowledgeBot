...
5. In `appsettings.json`, add a `KnowledgeBot` section with:
...
### TASK-11 — Add Unit Tests Project
...
### TASK-12 — Improve Sentence Extraction in AnswerComposer
...
### TASK-13 — Add Pagination / Multi-turn Support
...
### TASK-14 — Dockerize the Application
...
### TASK-15 — Add Request Logging Middleware
